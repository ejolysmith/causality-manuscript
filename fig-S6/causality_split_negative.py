...
#EJS1
with open(path_to_statistics + 'EJS1_split.pkl', 'rb') as f:
    data = pickle.load(f)
...
#EJS2
with open(path_to_statistics + 'EJS2_split.pkl', 'rb') as f:
    data = pickle.load(f)
...
#EJS7
with open(path_to_statistics + 'EJS7_split.pkl', 'rb') as f:
    data = pickle.load(f)
...
with open(path_to_statistics + 'PA52_normalMC_split.pkl', 'rb') as f:
    data = pickle.load(f)
...
with open(path_to_statistics + 'PA52_0p5uMIPTG_split.pkl', 'rb') as f:
    data = pickle.load(f)
...
#PA52 with  2uM IPTG:
with open(path_to_statistics + 'PA52_2uMIPTG_split.pkl', 'rb') as f:
    data = pickle.load(f)
...
#PA53 with normal MC :
with open(path_to_statistics + 'PA53_split.pkl', 'rb') as f:
    data = pickle.load(f)
...
#PA52 with 1uM IPTG:
with open(path_to_statistics + 'PA52_1uMIPTG_split.pkl', 'rb') as f:
    data = pickle.load(f)
