...
#SBATCH --job-name rerun_s7
#SBATCH --output=rerun_s7_output_%j.txt
...
python -u s7_v1_rerun_2_e.py 80 1
python -u s7_v2_rerun_2_e.py 80 1
python -u s7_v3_rerun_2_e.py 80 1
