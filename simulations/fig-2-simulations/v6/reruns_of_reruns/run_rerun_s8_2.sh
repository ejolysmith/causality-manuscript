...
#SBATCH --job-name rerun_s8
#SBATCH --output=rerun_s8_output_%j.txt
...
python -u s8_v1_rerun_2_e.py 80 1
python -u s8_v2_rerun_2_e.py 80 1
python -u s8_v3_rerun_2_e.py 80 1
