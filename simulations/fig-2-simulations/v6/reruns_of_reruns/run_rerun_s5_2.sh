...
#SBATCH --job-name rerun_s5
#SBATCH --output=rerun_s5_output_%j.txt
...
python -u s5_v1_rerun_2_e.py 80 1
python -u s5_v2_rerun_2_e.py 80 1
python -u s5_v3_rerun_2_e.py 80 1
