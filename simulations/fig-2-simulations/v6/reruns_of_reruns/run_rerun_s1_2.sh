...
#SBATCH --job-name rerun_s1
#SBATCH --output=rerun_s1_output_%j.txt
...
python -u s1_v1_rerun_2_e.py 80 1
python -u s1_v2_rerun_2_e.py 80 1
python -u s1_v3_rerun_2_e.py 80 1
