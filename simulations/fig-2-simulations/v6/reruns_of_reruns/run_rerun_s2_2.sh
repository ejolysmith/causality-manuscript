...
#SBATCH --job-name rerun_s2
#SBATCH --output=rerun_s2_output_%j.txt
...
python -u s2_v1_rerun_2_e.py 80 1
python -u s2_v2_rerun_2_e.py 80 1
python -u s2_v3_rerun_2_e.py 80 1
