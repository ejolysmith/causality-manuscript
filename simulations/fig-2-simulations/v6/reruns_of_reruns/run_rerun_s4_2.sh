...
#SBATCH --job-name rerun_s4
#SBATCH --output=rerun_s4_output_%j.txt
...
python -u s4_v1_rerun_2_e.py 80 1
python -u s4_v2_rerun_2_e.py 80 1
python -u s4_v3_rerun_2_e.py 80 1
