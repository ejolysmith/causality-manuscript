...
#SBATCH --job-name rerun_s9
#SBATCH --output=rerun_s9_output_%j.txt
...
python -u s9_v1_rerun_2_e.py 80 1
python -u s9_v2_rerun_2_e.py 80 1
python -u s9_v3_rerun_2_e.py 80 1
