...
def s5_v1_covariance(inputs2):
    ...
    while time < endtime/100:
        ...
        if T < len(jump_times) - 1 : #If we have some jumps remaining
            ...
            x_birth_rate = 1 * lamda * ( y/volume + 0.01 )  / ( y/volume + 0.01 + ( (x/volume) / (0.01 + w/volume))**2 )
            ...
            maximal_rate =  lamda_z * w /V0 + 1 * lamda  + lamda + lamda_w * Vmax  #Set with the assumption that volume at most
