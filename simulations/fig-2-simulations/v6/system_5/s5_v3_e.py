...
def s5_v1_covariance(inputs2):
    ...
    while time < endtime/100:
        ...
        if T < len(jump_times) - 1 : #If we have some jumps remaining
            ...
            x_birth_rate = 0.5*lamda * volume / (1 + ( (x/volume) / (0.01 + z/volume))**3 )
            ...
            maximal_rate =  lamda_z * Vmax + 1.5 * lamda * Vmax #Set with the assumption that volume at most
...
# =============================================================================
    ...
    while time < endtime:
        ...
        if T < len(jump_times) - 1 : #If we have some jumps remaining
            ...
            shadow_birth_rate = maximal_rate - (x_birth_rate + y_birth_rate + z_birth_rate)                                                                    #doubles (ensured by parameteres of cell divison)
