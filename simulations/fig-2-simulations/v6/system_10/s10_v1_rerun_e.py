...
AAA = np.loadtxt(path_2 + '/system_' +system_number +'/vol_dynamic_'+volume_number+'/results/bad_parameters/s'+system_number+'_v'+volume_number+'_bad_conc_A.csv')

BB = np.loadtxt(path_2 + '/system_' +system_number +'/vol_dynamic_'+volume_number+'/results/bad_parameters/s'+system_number+'_v'+volume_number+'_bad_conc_B.csv')
CC = np.loadtxt(path_2 + '/system_' +system_number +'/vol_dynamic_'+volume_number+'/results/bad_parameters/s'+system_number+'_v'+volume_number+'_bad_conc_C.csv')
omegaa = np.loadtxt(path_2 + '/system_' +system_number +'/vol_dynamic_'+volume_number+'/results/bad_parameters/s'+system_number+'_v'+volume_number+'_bad_conc_omega.csv')
...
if lamdaa.ndim > 0:
    ...
    blank = [lamdaa, lamda_za, lamda_wa, beta_xa, beta_ya, beta_za, beta_wa, ka, AA, BB, CC, omegaa]
