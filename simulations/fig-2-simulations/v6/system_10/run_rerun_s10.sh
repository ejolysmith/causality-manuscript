...
#SBATCH --job-name rerun_s10
#SBATCH --output=rerun_s10_output_%j.txt
...
python -u s10_v1_rerun_e.py 40 1
python -u s10_v2_rerun_e.py 40 1
python -u s10_v3_rerun_e.py 40 1
