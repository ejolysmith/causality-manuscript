...
pixels = np.loadtxt('cenx_PA52_normalMC.txt', delimiter = ',')
cfp = np.loadtxt('cfp_PA52_normalMC.txt', delimiter = ',')
yfp = np.loadtxt('yfp_PA52_normalMC.txt', delimiter = ',')
rfp = np.loadtxt('rfp_PA52_normalMC.txt', delimiter = ',')
growth_rate = np.loadtxt('growthrate_PA52_normalMC.txt', delimiter = ',')
areas = np.loadtxt('area_PA52_normalMC.txt', delimiter = ',')
frames = np.loadtxt('frame_PA52_normalMC.txt', delimiter = ',')
cell_number = np.loadtxt('cellNo_PA52_normalMC.txt', delimiter = ',')
fov = np.loadtxt('FOV_PA52_normalMC.txt', delimiter = ',')
...
with open('../thresholding_final_statistics/PA52_normalMC_thresholding.pkl', 'wb') as f:
