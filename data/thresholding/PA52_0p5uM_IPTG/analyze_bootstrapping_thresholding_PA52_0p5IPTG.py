...
pixels = np.loadtxt('cenx_PA52_0p5IPTG.txt', delimiter = ',')
cfp = np.loadtxt('cfp_PA52_0p5IPTG.txt', delimiter = ',')
yfp = np.loadtxt('yfp_PA52_0p5IPTG.txt', delimiter = ',')
rfp = np.loadtxt('rfp_PA52_0p5IPTG.txt', delimiter = ',')
growth_rate = np.loadtxt('growthrate_PA52_0p5IPTG.txt', delimiter = ',')
areas = np.loadtxt('area_PA52_0p5IPTG.txt', delimiter = ',')
frames = np.loadtxt('frame_PA52_0p5IPTG.txt', delimiter = ',')
cell_number = np.loadtxt('cellNo_PA52_0p5IPTG.txt', delimiter = ',')
fov = np.loadtxt('FOV_PA52_0p5IPTG.txt', delimiter = ',')
...
random_index = np.array(range(len(cfp)))
...
for sample in range(number_of_samples):
    ...
    #### DRIFT CORRECTION ###
    number_of_frames = 175 #Set this to the length of the time trafes
...
ETAXA_ERR = np.std(etaxa_final)*2
ETAYA = np.average(etaya_final)
ETAYA_ERR = np.std(etaya_final)*2
...
with open('../thresholding_final_statistics/PA52_0p5uMIPTG_thresholding.pkl', 'wb') as f:
