...
pixels = np.loadtxt('cenx_EJS2.txt', delimiter = ',')
cfp = np.loadtxt('cfp_EJS2.txt', delimiter = ',')
yfp = np.loadtxt('yfp_EJS2.txt', delimiter = ',')
rfp = np.loadtxt('rfp_EJS2.txt', delimiter = ',')
growth_rate = np.loadtxt('growthrate_EJS2.txt', delimiter = ',')
areas = np.loadtxt('area_EJS2.txt', delimiter = ',')
frames = np.loadtxt('frame_EJS2.txt', delimiter = ',')
cell_number = np.loadtxt('cellNo_EJS2.txt', delimiter = ',')
fov = np.loadtxt('FOV_EJS2.txt', delimiter = ',')



#The time traces that have lost the plasmid:
#Using those from EJS1 because there were too few cells that lost plasmid 
#in EJS2. EJS1 was done in same mothermachine experiment as EJS2 (different lane). 
...
with open('../thresholding_final_statistics/EJS2_thresholding.pkl', 'wb') as f:
