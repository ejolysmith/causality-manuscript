...
pixels = np.loadtxt('cenx_PA53.txt', delimiter = ',')
cfp = np.loadtxt('cfp_PA53.txt', delimiter = ',')
yfp = np.loadtxt('yfp_PA53.txt', delimiter = ',')
rfp = np.loadtxt('rfp_PA53.txt', delimiter = ',')
growth_rate = np.loadtxt('growthrate_PA53.txt', delimiter = ',')
areas = np.loadtxt('area_PA53.txt', delimiter = ',')
frames = np.loadtxt('frame_PA53.txt', delimiter = ',')
cell_number = np.loadtxt('cellNo_PA53.txt', delimiter = ',')
fov = np.loadtxt('FOV_PA53.txt', delimiter = ',')
...
with open('../thresholding_final_statistics/PA53_thresholding.pkl', 'wb') as f:
