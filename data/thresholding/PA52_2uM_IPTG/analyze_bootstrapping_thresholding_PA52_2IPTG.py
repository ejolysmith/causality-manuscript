...
pixels = np.loadtxt('cenx_PA52_2IPTG.txt', delimiter = ',')
cfp = np.loadtxt('cfp_PA52_2IPTG.txt', delimiter = ',')
yfp = np.loadtxt('yfp_PA52_2IPTG.txt', delimiter = ',')
rfp = np.loadtxt('rfp_PA52_2IPTG.txt', delimiter = ',')
growth_rate = np.loadtxt('growthrate_PA52_2IPTG.txt', delimiter = ',')
areas = np.loadtxt('area_PA52_2IPTG.txt', delimiter = ',')
frames = np.loadtxt('frame_PA52_2IPTG.txt', delimiter = ',')
cell_number = np.loadtxt('cellNo_PA52_2IPTG.txt', delimiter = ',')
fov = np.loadtxt('FOV_PA52_2IPTG.txt', delimiter = ',')
...
with open('../thresholding_final_statistics/PA52_normalMC_2uMIPTG_thresholding.pkl', 'wb') as f:
