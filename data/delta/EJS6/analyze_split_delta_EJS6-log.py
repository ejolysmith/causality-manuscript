...
for _ in range(1):
    ...
    for sample in range(number_of_samples):
        ...
        for i in range(len(frames_sample)):
            if frames_sample[i] < 100 or frames_sample[i] > 130: #Purging measurement noie
        ...
        for i in range(len(frames_sample)):
            if frames_sample[i] < 100 or frames_sample[i] > 130:
                if frames_sample[i] < number_of_frames:
...
with open('final_statistics/EJS6_split.pkl', 'wb') as f:
