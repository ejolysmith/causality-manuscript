...
bin_time = 5 #5min for this experiment
...
### CALCULATING ETAS ###
        ...
        if number > 0 :
            ...
            covxy = (xy_bins - cfp_average*yfp_average)
            ...
            rhoxy = covxy/np.sqrt(varx_2*vary_2)
            ...
            #etaxx = varx/cfp_average_2/cfp_average_2
            #etayy = vary/yfp_average_2/yfp_average_2
...
rhoxy_final = np.array(rhoxy_final)
...
RHOXY = np.average(rhoxy_final)
RHOXY_ERR = np.std(rhoxy_final)*2
...
with open('final_statistics/EJS1_bootstrapping.pkl', 'wb') as f:
