...
### CALCULATING ETAS ###
        ...
        if number > 0 :
            ...
            cfp_average_2 = cfp_average - (cfp_average_b - 0*np.sqrt(varx_b))
                
                
            yfp_average = yfp_average/number
            #Correcting the autofluorescnece/background:
            yfp_average_2 = yfp_average - (yfp_average_b - 0*np.sqrt(vary_b))
...
with open('final_statistics/EJS1_split.pkl', 'wb') as f:
