...
for sample in range(number_of_samples):
    ...
    Z = np.polyfit(np.array(time_bins[50:]), rfp_time_bins[50:], 2)
    P = np.poly1d(Z)
...
### CALCULATING ETAS ###
        ...
        for i in range(len(pixels_sample)):
            ...
            if frames_sample[i] > 135 or frames_sample[i] < 100: #Purging measurement noise
...
with open('final_statistics/EJS3_0p5mMIPTG_bootstrapping.pkl', 'wb') as f:
