...
for p in range(20, 20 + number_of_positions):
...
final_data = {'etaxz': ETAYZ, 'etaxz_err': ETAYZ_ERR, 'etayz': ETAXZ, 'etayz_err': ETAXZ_ERR, \
              ...
              'rhoxa': RHOYL, 'rhoxa_err': RHOYL_ERR, 'rhoya': RHOXL, 'rhoya_err': RHOXL_ERR, \
...
with open('../final_statistics/EJS9_bootstrapping.pkl', 'wb') as f:
